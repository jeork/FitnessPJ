...
public class WorkoutController {
    ...
    public WorkoutController(RoutineRepository routineRepository, UserService userService, RoutineService routineService, WorkoutService workoutService, WorkoutSetService workoutSetService) {
...
public String myRoutine(Model model) {
    model.addAttribute("routineUpdateDto", new RoutineUpdateDto());
    return "my_routine";
}
}
